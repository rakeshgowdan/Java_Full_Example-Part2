/*example shows how to create a simple generics class. We have created SimpleGeneric class, 
 * which accepts single type parameter. Look at the generics class definition, 
 * the type parameter should be followed by class name and should contain with in <>, 
 * here T defines the type parameter. 
